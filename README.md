...
# 📖 [Hello Webpack App] <a name="about-project"></a>

**Hello Webpack App** is a fullstack web application using webpack,react,ruby on rails which generates random greetings.
...
```sh
  cd my-folder
  git clone https://github.com/K0ppai/hello-rails-react.git
```
